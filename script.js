...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/gearvr", {
        controller: "GearVRCtrl",
        templateUrl: "templates/gearvr.html"
    })
...
app.controller("MainCtrl", function ($scope) {
    ...
    var adjustLocations = function () {
        ...
        firstQuoteLocation = 230;

        downloadLocation = firstQuoteLocation + screen.height * 0.25;
        panoramaLocation = downloadLocation + screen.height * 0.75;
        videoLocation = panoramaLocation + screen.height *0.7;


        contactLocation = videoLocation + screen.height *1.5;

        //if (width <= 320) {

        //    firstQuoteLocation =  296 ;
        //    panoramaLocation = firstQuoteLocation + 152;
        //    videoLocation = 1033;
        ...
        //	firstQuoteLocation = 309 ;
        //	panoramaLocation = 968 ;
        ...
        //    firstQuoteLocation = 377 ;
        //    panoramaLocation = firstQuoteLocation + 549;
    ...
    window.onscroll = function (event) {
        ...
        } else if ($(window).scrollTop() >= getFloor("#video-section")) {
        ...
        if ($(window).scrollTop() >= getFloor("#first-quote-section")) {
